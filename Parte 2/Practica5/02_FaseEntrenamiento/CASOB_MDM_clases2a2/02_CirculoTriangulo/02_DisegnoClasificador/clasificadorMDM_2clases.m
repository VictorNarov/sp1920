...
load('01_SeleccionDescriptores/DatosGenerados/datos_CircTrian.mat')
...
%% Guardamos los datos
save('02_DisegnoClasificador/DatosGenerados/MDM_CircTrian','espacioCcas', 'd12', 'coeficientes_d12', 'XoIRed', 'YoIRed', 'nombresProblemaOIRed');