...
for i=1:numClases
    for j=1:numImagenesPorClase
        ...
        nombreImagen = [nombreClases{i} num2str(j,'%2d') '.tif']
...
% figure,subplot(3,2,ind), imshow(Ibin), title('Sin filtrar'), subplot(3,2,ind+1), imshow(IbinFilt),title('Filtrada');
...
%% --------------------------------
save('01_GeneracionDatos/DatosGenerados/conjunto_datos', 'X','Y')
